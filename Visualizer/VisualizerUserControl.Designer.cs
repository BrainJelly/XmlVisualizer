...
namespace XmlVisualizer
{
    public partial class VisualizerUserControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.transformFormatComboBox = new System.Windows.Forms.ComboBox();
			...
			this.applyXsltButton.TabIndex = 9;
			...
			// openXsltFileDialog
			// 
			this.openXsltFileDialog.Filter = "XSLT files|*.xslt;*.xsl|All files|*.*";
			...
			this.applyXpathButton.TabIndex = 16;
			...
			this.xPathTypeComboBox.TabIndex = 15;
			...
			this.showLabel.Location = new System.Drawing.Point(314, 95);
			...
			this.xPathComboBox.TabIndex = 14;
			...
			this.xsltFileComboBox.Size = new System.Drawing.Size(240, 21);
			...
			this.treeViewCheckBox.TabIndex = 22;
			...
			this.selectXsltFileButton.TabIndex = 7;
			...
			this.newXsltFileButton.TabIndex = 8;
			...
			this.openInBrowserButton.TabIndex = 19;
			...
			this.toClipboardButton.TabIndex = 20;
			...
			this.newXsdFileButton.TabIndex = 12;
			...
			this.xsdFileComboBox.TabIndex = 10;
			...
			this.selectXsdFileButton.TabIndex = 11;
			...
			this.applyXsdButton.TabIndex = 13;
			...
			// 
			// transformFormatComboBox
			// 
			this.transformFormatComboBox.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.transformFormatComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.transformFormatComboBox.FormattingEnabled = true;
			this.transformFormatComboBox.Items.AddRange(new object[] {
            "Html",
            "Xml"});
			this.transformFormatComboBox.Location = new System.Drawing.Point(351, 39);
			this.transformFormatComboBox.Name = "transformFormatComboBox";
			this.transformFormatComboBox.Size = new System.Drawing.Size(52, 21);
			this.transformFormatComboBox.TabIndex = 6;
			// 
			// label1
			// 
			...
			this.Controls.Add(this.transformFormatComboBox);
		...
		private System.Windows.Forms.ComboBox transformFormatComboBox;
